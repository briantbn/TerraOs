...
def conectividad_hidraulica():
    ...
    try:
        ...
        # ---- 1) Terreno (reusa el helper existente, sin tocarlo) ----
        region, elevacion, agua_fuente = _preparar_dem_y_agua(lat, lon, radius_km)
        ...
        # ---- 2) Conectividad real (reusa _conectividad_hidraulica pasándole
        #         HAND en vez de elevación absoluta: mismo algoritmo,
        #         barrera más realista) ----
        ...
        # ---- 3) Cuerpo de agua vectorial más cercano (tipo/coeficiente) ----
