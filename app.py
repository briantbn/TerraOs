...
def inundacion_animacion():
    ...
    try:
        ...
        # bandas proporcionales). bestEffort para no reventar de cómputo.
        ...
        max_costo_m = max_costo_dict.get('cost') or max_costo_dict.get('constant') or 0
        # El nombre de banda de cumulativeCost es 'cumulative_cost'; cubrimos
        # variantes por las dudas de versión de la librería.
        if not max_costo_m:
