...
# ──────────────────────────────────────────────────────────────────────────
# Mismo patrón defensivo. Envoltura histórica del agua (occurrence + recurrence,
# JRC GSW v1.5 2024) leída por ventana desde COGs propios alojados en Hugging
# Face — no depende de GEE. Además de rasterio (ya usado por humedales_inta y
# terreno_merit_hydro), necesita 'shapely' en requirements.txt.
try:
    ...
    print(f'⚠️ Módulo jrc_raster_regional no disponible ({_exc_jrc_raster}). '
          ...
          f'/envoltura_historica_cuerpo devolverá error hasta que se resuelva.')
