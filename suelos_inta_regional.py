...
SUELO_CAPAS = [
    {
        ...
        # Tolerancia de simplificación en grados (~1 grado = 111km), aplicada
        # UNA vez al cargar la capa -- ver nota junto a _cargar_capa(). A
        # 1:50.000 el detalle real importa (son cartas de precisión), así
        # que la tolerancia es chica: ~30m, imperceptible a esa escala.
        'simplificar_grados': 0.0003,
    },
    {
        'nombre': 'Córdoba',
    ...
    },
    {
        ...
        # Ya es "zonas grandes" de por sí -- tolerancia más floja.
    ...
    },
    {
        ...
        'bbox': None,
        # A 1:1.000.000 un vértice cada ~1km es indistinguible visualmente
        # pero reduce drásticamente la cantidad de puntos por polígono --
        # esta es la capa que SIEMPRE termina cargándose para cualquier
        # punto fuera de Santa Fe/Córdoba/Buenos Aires (ej. Corrientes),
        # así que es la que más importa aliviar.
