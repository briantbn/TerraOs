...
def _bbox_desde_punto(lat, lon, buffer_km):
    ...
    # Techo defensivo: todas las funciones públicas de este módulo pasan
    # por acá. buffer_km llega directo de un parámetro de la URL (ver
    # app.py) sin validar arriba — sin este límite, un pedido con un
    # buffer_km gigante leería una ventana igual de gigante del raster.
    # 25km alcanza de sobra para el uso real (default es 5km).
    buffer_km = min(buffer_km, 25.0)
