...
# "extent" (maximum water extent) es binario: 0 = nunca hubo agua, 255 =
# alguna vez ocupó ese píxel en 40 años. Sin nodata real (todo el país tiene
# una respuesta válida), confirmado con gdalinfo -mm sobre el tile original.
